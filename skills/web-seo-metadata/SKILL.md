...
# Web SEO Metadata Skill (generic)

Use this skill when a page needs to be discoverable and shareable. For framework-specific implementation patterns, use `react-seo-metadata`, `preact-seo-metadata`, or `vue-seo-metadata`.
